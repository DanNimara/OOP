...
int main() {
    ...
    cin >> *mp1 >> *mp2;
    std::cout <<*mp3;
    Dezinfectant* d1 = new DezinfectantBacterii(100000000, std::vector({"sulfati non-ionici", "sulfati cationici", "parfumuri", "Linalool", "Metilpropanol butilpentil"}), std::vector<std::string>({"lemn", "sticla", "metal", "ceramica", "marmura"}));
    Dezinfectant* d2 = new DezinfectantVirusi(50000000, std::vector({"Alkil Dimetilm Benzil Crlorura de amoniu", "parfumuri", "Butilpentil metilpropinal"}), std::vector<std::string>({"lemn", "sticla", "ceramica", "marmura”}));
    Dezinfectant* d3 = new DezinfectantFungi(1400000, std::vector({"Alkil Etil Benzil Crlorura de amoniu", "parfumuri", "Butilpentil metilpropinal"}), std::vector<std::string>({"sticla", "plastic"}));
